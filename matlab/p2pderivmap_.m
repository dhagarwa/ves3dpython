function diff = p2pderivmap_(p_in, p_out)
...
%diff = [du2/du1, du2/dv1, dv2/du1, dv2/dv1] 
    ...
    if p1==1 && p2==1 
        diff = [1 + 0*p_in.u_,0*p_in.u_,0*p_in.u_,1+0*p_in.u_];
    elseif p1 == 1 && p2==2
        diff = [0*p_in.u_,0*p_in.u_,0*p_in.u_,0*p_in.u_];
    elseif p1==1 && p2==3
        diff = [1 + 0*p_in.u_,0*p_in.u_,0*p_in.u_,1+0*p_in.u_];
    elseif p1==1 && p2==4
        diff =[1 + 0*p_in.u_,0*p_in.u_,0*p_in.u_,1+0*p_in.u_];
    ...
    elseif p1==1 && p2==5
        d1 = cos(p_in.u_).*sin(p_in.v_)./(1-sin(p_in.u_).^2.*sin(p_in.v_).^2).^(0.5);
        d2 = sin(p_in.u_).*cos(p_in.v_)./(1-sin(p_in.u_).^2.*sin(p_in.v_).^2).^(0.5);
    ...
    elseif p1==3 && p2==5
        d1 = -cos(p_in.u_).*cos(p_in.v_)./(1-sin(p_in.u_).^2.*cos(p_in.v_).^2).^(0.5);
        d2 = sin(p_in.u_).*sin(p_in.v_)./(1-sin(p_in.u_).^2.*cos(p_in.v_).^2).^(0.5);
